"""
How-to use the NetworkConfigGen module (with YAML parameters)
=============================================================

Run the script with the following command (assuming that the `networkconfgen` and 'pyyaml' library is installed):
